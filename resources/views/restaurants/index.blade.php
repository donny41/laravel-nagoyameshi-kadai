                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <hr class="my-2">
                                            <p class="mb-1">
                                                <span class="nagoyameshi-star-rating me-1" data-rate="{{ round((float)$restaurant->reviews->avg('score') * 2) / 2 }}"></span>
                                                {{ number_format(round((float)$restaurant->reviews->avg('score'), 2), 2) }}（{{ $restaurant->reviews->count() }}件）
                                            </p>
                                            <div class="mb-1">
